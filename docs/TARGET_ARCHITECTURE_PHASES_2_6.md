...
- El gate de límites de módulo impide dependencias nuevas no autorizadas entre
  ...
  cubren HTTP, Server Actions, 92 RPC y 14 operaciones Storage. La extracción
...
|---|---|---|
| P0-A arquitectura | límites de módulo; inventarios ejecutables de HTTP, Server Actions, RPC y Storage; cuarentena con worker/fixture local y entregas/mutaciones de Rendiciones; upload/download documental, exports y mutaciones laborales, y control plane atómicos, limitados y auditados. Faltan tenant sintético del resto laboral, adapter antimalware real, telemetría hospedada y runbooks operacionales | no |
