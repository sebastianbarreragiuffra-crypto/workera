...
export const SERVER_ACTION_SURFACES = [
  ...
  },
  {
    ...
    uploadMaxBytes: 10 * MIB, abuseControl: "DATABASE_RATE_LIMIT",
  ...
  },
  {
    ...
    uploadMaxBytes: 5 * MIB, abuseControl: "DATABASE_RATE_LIMIT", auditControl: "PROVIDER_IDEMPOTENCY",
    dataClass: "PERSONAL", blockers: ["LABOR_MULTI_TENANCY"],
  },
  {
    ...
    uploadMaxBytes: 5 * MIB, abuseControl: "DATABASE_RATE_LIMIT", auditControl: "PARTIAL",
    dataClass: "FINANCIAL", blockers: ["LABOR_MULTI_TENANCY"],
  },
  {
  ...
  },
  {
    ...
    uploadMaxBytes: null, abuseControl: "DATABASE_RATE_LIMIT", auditControl: "BUSINESS_LEDGER",
  ...
  },
  {
    ...
    dataClass: "SENSITIVE_HR", blockers: ["LABOR_MULTI_TENANCY"],
  },
  {
    ...
    abuseControl: "DATABASE_RATE_LIMIT", auditControl: "PARTIAL", dataClass: "SENSITIVE_HR",
  ...
  },
  {
    ...
    uploadMaxBytes: 5 * MIB, abuseControl: "DATABASE_RATE_LIMIT", auditControl: "BUSINESS_LEDGER",
    dataClass: "FINANCIAL", blockers: ["LABOR_MULTI_TENANCY"],
  },
  {
