...
export const REQUEST_SURFACES = [
  ...
  },
  {
    ...
    domain: "workforce", authentication: "SESSION", tenantScope: "EXPLICIT_COMPANY",
    authorization: "Empresa laboral activa revalidada por membresía; RPC revalida rol, MFA, período y cuota.",
    mutates: false, maxBodyBytes: null, idempotency: "READ_ONLY", abuseControl: "DATABASE_RATE_LIMIT",
    auditControl: "DATA_ACCESS_LEDGER", featureFlag: null, dataClass: "SENSITIVE_HR", blockers: [],
  },
  {
  ...
  {
    source: "src/app/(expenses)/empresas/[companySlug]/personas/route.ts", route: "/empresas/[companySlug]/personas", method: "GET", kind: "USER_API",
    domain: "workforce", authentication: "SESSION", tenantScope: "EXPLICIT_COMPANY",
    authorization: "La membresía ACTIVE, el workspace laboral y el rol se revalidan antes de seleccionar la empresa.",
    mutates: true, maxBodyBytes: null, idempotency: "NOT_APPLICABLE", abuseControl: "READ_ONLY_NO_LIMIT",
    auditControl: "NOT_APPLICABLE", featureFlag: null, dataClass: "AUTH", blockers: [],
  },
  {
