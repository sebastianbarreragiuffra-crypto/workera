...
export const REQUEST_SURFACES = [
  ...
  },
  {
    ...
    domain: "workforce", authentication: "SESSION_PRIVILEGED_ROLE", tenantScope: "LEGACY_ARCOTEX",
    authorization: "SUPER_ADMIN o ADMIN_RRHH; batchId UUID y RLS del cliente de sesión.",
  ...
  },
  {
    ...
    authorization: "Perfil activo, alcance de áreas por rol y RLS del cliente de sesión.",
    mutates: false, maxBodyBytes: null, idempotency: "READ_ONLY", abuseControl: "MISSING",
  ...
  },
  {
    ...
    domain: "workforce", authentication: "SESSION_PRIVILEGED_ROLE", tenantScope: "LEGACY_ARCOTEX",
    authorization: "SUPER_ADMIN o ADMIN_RRHH, RLS y URL privada firmada por 60 segundos.",
    mutates: false, maxBodyBytes: null, idempotency: "READ_ONLY", abuseControl: "MISSING",
    auditControl: "MISSING", featureFlag: null, dataClass: "FINANCIAL",
    blockers: ["APPLICATION_RATE_LIMIT", "EXPORT_AUDIT", "LABOR_MULTI_TENANCY"],
  },
