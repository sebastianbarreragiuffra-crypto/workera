...
const GROUPS = [
  { id: "grp-production", code: "PRODUCTION", company_id: "0c4c0000-0000-0000-0000-000000000003" },
  { id: "grp-installation", code: "INSTALLATION", company_id: "0c4c0000-0000-0000-0000-000000000003" },
  { id: "grp-administration", code: "ADMINISTRATION", company_id: "0c4c0000-0000-0000-0000-000000000003" },
];
...
// Estos tests cubren el ensamble tenant-aware genérico. El contrato cerrado
// específico de ARCOTEX se verifica en daily-review.test.ts con su padrón.
const COMPANY_ID = "0c4c0000-0000-0000-0000-000000000003";
