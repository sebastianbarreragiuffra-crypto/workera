...
- `GET /api/jobs/expense-ocr` — respaldo diario de la cola OCR de Rendiciones. La asociación intenta procesar inmediatamente con `after()` y este endpoint recupera trabajos pendientes. Misma autenticación Bearer, ruta/método exactos y secretos de al menos 32 bytes. Ver `docs/EXPENSE_OCR_OPERATIONS.md`.
