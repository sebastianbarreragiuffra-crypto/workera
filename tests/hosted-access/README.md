...
`test-results/hosted-access-sanitized/results.jsonl`, con nombre y estado del
caso. El arnés deshabilita capturas, video y trazas, y nunca guarda cuerpo,
correo, UUID, cookie ni token.

## Limpieza segura

Cerrar las sesiones del navegador al terminar, revocar las sesiones de las
cuatro cuentas desde Auth y volver a dejar la aprobación en `blocked` en el
