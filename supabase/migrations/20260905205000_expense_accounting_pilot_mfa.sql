-- El switch financiero del piloto contable es una mutación privilegiada del
-- control plane. Exige MFA antes de adquirir locks o modificar estado y vuelve
-- a validar la autorización después del lock.
