...
-- No forma parte del primer snapshot confirmado; queda inactivo hasta la
-- prueba posterior de desactivación atómica.
update public.employees set active = false
where external_workera_id = 'EXCEL-11111111-1';
