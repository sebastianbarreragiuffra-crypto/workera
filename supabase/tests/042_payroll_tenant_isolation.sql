...
insert into public.company_memberships (id, user_id, company_id, role, active) values
  ('96000000-0000-0000-0000-000000000201', '96000000-0000-0000-0000-000000000101', '0a4c0000-0000-0000-0000-000000000001', 'ADMIN_RRHH', true),
...
where cm.id in (
  '96000000-0000-0000-0000-000000000201',
  '96000000-0000-0000-0000-000000000202'
);
...
set active = false
where id = '96000000-0000-0000-0000-000000000201';
set local role authenticated;
set local request.jwt.claim.sub = '96000000-0000-0000-0000-000000000101';
